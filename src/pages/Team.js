  ...
  return (
    <div>
      ...
      <CardGroup style={{justifyContent: "center"}}>
        ...
        <FaceCard name={"Elliot van Huijgevoort"} text={"/team"} gith={"https://github.com/ElliotVH"} linked={"https://www.linkedin.com/in/elliot-van-huijgevoort"} year={"2022"} image={elliot} hometown="Ithaca, NY"></FaceCard>    
      </CardGroup>
